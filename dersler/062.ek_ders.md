...
8. Adım: `push(handler, 1)` işlemi sonrası durum.
    ...
    * * 8 2 1   --> Kuyruktaki verilerin görünümü
    T           --> Tail Göstesici(Bu adımda koddaki `%` işleminden dolayı Tail göstericisinin indeks değeri "0" oluyor)
...
12. Adım: `pop(handler, val)` işlemi sonrası durum.
    ...
    0 1 2 3 4   --> Indeks değerleri
    H           --> Head Göstesici(Bu adımda koddaki `%` işleminden dolayı Head göstericisinin indeks değeri "0" oluyor)
