...
⚠️ Derleyicilerin varsayılan uyarı ayarlarında(default) kodu derlediğiniz zaman **false positive** uyarı iletisi gelirse kod asla **commit** edilmemelidir ve **false positive** uyarı mesajları düzeltilip temizlenmelidir, bunun nedeni derleyicinin verdiği uyarıların giderilmesinin kodun kalitesi açısından önemli olmasıdır.
