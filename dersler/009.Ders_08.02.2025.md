...
📌 "C dilinde Bir fonksiyon bir başka fonksiyona bir yazıyı nasıl iletir?" biçiminde bir soruya aşağıdaki biçimde cevap verilebilir;  </br>
...
> 
> "34ali" ve enter girildiğinde buffer'da nasıl değişimler oluyor? Çok erken ise kalabilir." biçiminde bir soru soruldu ama önceden buna benzer işlemler yapıldığı için cevap verilmedi.
> 
> Sorulan soru-2;
> 
