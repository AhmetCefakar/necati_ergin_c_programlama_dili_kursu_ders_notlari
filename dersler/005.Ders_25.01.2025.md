...
😱 Aşağıdaki gibi kodlar Türkiye'deki bazı firmaların yaptığı mülakatlarda sorulduğu oluyormuş ve bu kursu bitiren kişiler yanıt olarak burada "**ub**" var diye yanıt verdiklerinde mülakatı yapan kişi trajikomik biçimde "_**ub** de ne demek programlar deteministtir olmaz öyle şey._" diyorlarmış!
```c
#include <stdio.h>
