...
Aşağıdaki sorular bu konuda mülakatlarda sorulabilecek sorulardır.
...
❗Her bir fonksiyonun geçerli olabilmesi için bir ana bloğa sahip olması gerekiyor. Herhangibir fonksiyonun ana bloğu şu şekilde ifade edilir: "**main block of a function**". [20:32:00]

❗Bir C programı çalışırken ilk önce "**main**" adındaki fonksiyon çağırılır, buna programın giriş fonksiyonu da denmektedir. Dİğer fonksiyonlar main fonksiyonu içerisindne çağırılmaktadır.

⚠️ Kursta en en düşük C standard olarak C99 standardı kabul edilmektedir.
...
Hatırlatma: C dilinde kullanılan **veri türleri(Data Types)** ikiye ayrılır bunlar: "**Basic Data Types**", "**User defined Data Types**".

Hatırlatma: "**Basic Data Types**" ifadesiyle aynı anlama gelen tanımlamalar aşağıdakilerdir;
- Fundimental Types
- Defould Types
- Buildin Types
- Primitive Types
