...
Test Fonksiyonu demek bir soruya yanıt olarak **doğru/yanlış(true/false)** biçiminde yanıt verecek olan fonksiyon demektir.
...
int main(void)
{
    ...
    // 'a' ve 'A' girildiğinde başarılı yanıt verilmesi isteniyorsa aşağıdaki gibi kullanılmalıdır.
