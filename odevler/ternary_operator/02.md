...
Aşağıda yanıtlar listelenmiştir, "isleap" fonksiyonunun tanımı(gövdesi) yazılmamıştır çünkü istenilen sadece koşul operatörü (ternary operator) ile ifadelerin yazılmasıdır.
