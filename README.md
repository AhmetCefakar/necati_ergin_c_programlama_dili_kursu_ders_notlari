# Necati Ergin C Programlama Dili Kursu Ders Notları

Buradaki içerik Necati Ergin tarafından verilen "C Programlama Dili Kursu" içeriğinin barındırmaktadır.
...
Bir biçimde C dili yazılım dünyasının tam merkezinde bulunuyor ve bu dili iyi seviyede bilmeden iyi bir yazılımcı olunması mümkün değildir, birden fazla </br>
programlama dili kullanılan yazılım projeleri de geliştiriliyor ve bu projelerdeki programlama dillerinin birbirleriyle konuşabilmesi için bu kursta hiç </br>
değinilmemiş olan "C ABI"dan yararlanılıyor. İlk işletim sistemi olan Unix ve ondna sonra yazılan yaygın kullanılan işletim sistemlerinin çekirdeklerinin </br> 
kayak kodları da neredeyse tamamen C diliyle yazılıyor. Rust, Zig, Odin, C3, Nim gibi dilleri kullanarak birşeyler yapılmak gibi bir amaç bile olsa ilk önce </br> 
C dilinin iyi seviyede öğrenilmesi ve ondan sonra diğer dillerin **kolayca** öğrenilip kullanılması doğru bir yaklaşımdır.
