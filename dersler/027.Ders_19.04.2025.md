...
> Cevap;
> 
> C++ diline girmek bu noktada doğru olmayacaktır ama kısaca cevap vermek gerekirse C++ dilinde C dilinde olmayan bazı araçlar ve bu araçlar ile fonksiyonların parametrelerinin `&prameter` biçiminde bildirilmesi gerekiyor, bu bildirimin neden gerektiği bilgisini tam anlayabilmek için C++ dilini biliyor olmak gerekecektir.
